...
const CourseCard = ({ course }) => {
    ...
    return (
        <div className="border-gray-100 border rounded-lg">
            <div className="bg-white shadow-md hover:shadow-xl rounded-lg px-5 pt-5 w-80 lg:w-96 h-[500px] lg:h-[485px]">
                <Link to={`/course/${_id}`}>
                    <a className="rounded-md">
                        <img className="rounded-md  object-cover h-60 w-fit" src={courseImage} alt="Course image" />
                    </a>
                </Link>
                <div className="mt-4 flex flex-col justify-between h-[200px] lg:h-[210px] gap-2 lg:gap-0">
                    <div className="flex flex-col justify-between h-24">
                        ...
                        <h3 className="text-gray-600 font-light text-sm">{shortDescription}</h3>
